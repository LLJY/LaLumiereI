...
export class LoadingDialogService {
  ...
  public loadingDialog: HTMLIonLoadingElement;
  constructor(private loading: LoadingController) {
    // get the loading dialog when the singleton instance is created
    loading.create({
      message: "...",
    }).then(result => {
  ...
  async getLoading() {
    while(this.loadingDialog==null){}
    this.loadingDialog.message = this.loadingMessages[Math.floor(Math.random() * this.loadingMessages.length)];
